...
"""
    ...
    def test_build_jobs_reads_asset_bible_bullet_entries(
        self,
    ) -> None:
        text = """
# Asset Bible
...
## Character Assets
- Asset name: 林夜_黑袍白发宗主造型
  - Canonical asset name: 林夜_黑袍白发宗主造型
  - Output directory: 人设资产
  - Prompt: GPT-image-2，16:9，角色三视图，白色背景，不要复杂场景。

## Scene Assets
- Asset name: 鬼王宗宗门大殿_母图
  - Canonical asset name: 鬼王宗宗门大殿_母图
  - Output directory: 场景资产
  - Prompt: GPT-image-2，16:9，空场景，鬼王宗宗门大殿，不要人物。

## Prop, Interface, Beast, Vehicle Assets
- Asset name: 天机一型手机_三视图
  - Canonical asset name: 天机一型手机_三视图
  - Output directory: 道具资产
  - Prompt: GPT-image-2，16:9，道具三视图，正面屏幕、背面摄像头、侧面厚度。
"""
    ...
    def test_build_jobs_extracts_asset_bible_reference_variants(
        self,
    ) -> None:
        text = """
## Character Assets
- Asset name: 白清玄_黑纱长裙黑莲造型
  - Output directory: 人设资产
  - Prompt: GPT-image-2，16:9，角色三视图。

- Asset name: 姹女教女修_黑纱群像模板
  - Output directory: 人设资产
  - Prompt: GPT-image-2，16:9，群像模板。

- Asset name: 白清玄_黑色绣花旗袍高跟鞋造型
  - Output directory: 人设资产
  - Prompt: 上传参考图：白清玄_黑纱长裙黑莲造型 = 第01-03章 图片5（人脸身份参考、旧造型参考）；姹女教女修_黑纱群像模板（同门服制参考）。GPT-image-2，16:9，保持同一张脸，只换旗袍。

## Prop, Interface, Beast, Vehicle Assets
- Asset name: 天机一型手机_三视图
  - Output directory: 道具资产
  - Prompt: GPT-image-2，16:9，手机三视图。

- Asset name: 抖音纯享版_空首页
  - Output directory: 道具资产
  - Prompt: 上传参考图：天机一型手机_三视图（手机本体参考）。GPT-image-2，16:9，手机屏幕 UI。
"""
        ...
        self.assertEqual(
            outfit.depends_on,
            ["白清玄_黑纱长裙黑莲造型", "姹女教女修_黑纱群像模板"],
        )
        self.assertEqual(
            [(ref.asset_name, ref.path, ref.purpose) for ref in outfit.reference_images],
            [
                ("白清玄_黑纱长裙黑莲造型", "人设资产/白清玄_黑纱长裙黑莲造型.png", "人脸身份参考、旧造型参考"),
                ("姹女教女修_黑纱群像模板", "人设资产/姹女教女修_黑纱群像模板.png", "同门服制参考"),
            ],
        )
        self.assertEqual(interface.depends_on, ["天机一型手机_三视图"])
        self.assertEqual(
            [(ref.asset_name, ref.path, ref.purpose) for ref in interface.reference_images],
            [("天机一型手机_三视图", "道具资产/天机一型手机_三视图.png", "手机本体参考")],
        )
