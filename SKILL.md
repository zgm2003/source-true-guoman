...
15. For formal production batches, run `copy-packager` after source index, asset bible, faithful feed, and feed audit exist; keep copy packs as a user-facing `生产资产` artifact.
...
- Keep the index under internal production assets, normally `生产资产/_内部/source-index.md` or a project-specific equivalent inside `生产资产/_内部/`. It is a private working aid unless the user asks to see it.
